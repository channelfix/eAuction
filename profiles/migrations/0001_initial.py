# Generated by Django 2.0.4 on 2018-06-15 07:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('records', models.CharField(blank=True, max_length=150)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.AddField(
            model_name='product',
            name='session',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='auction_products', to='livestream.Session'),
        ),
        migrations.AddField(
            model_name='product',
            name='tag',
